...
(function () {
    ...
    ixmaps.legend.loadExternalLegend = function (szUrl) {
        ...
        szHtml += '<div id="map-legend-delete" style="position:absolute;top:0.4em;right:-1em;border:solid 1px;padding:1.1em 1.2em 0.9em 1.2em;border-radius:2em">';
        szHtml += '<b><a href="javascript:ixmaps.legend.removeExternalLegend(\'' + szUrl + '\')" style="text-decoration:none">X</a></b></div>';
    ...
    ixmaps.legend.setExternalLegend = function (szLegend) {
        ...
        szHtml += '<div id="map-legend-delete" style="position:absolute;top:0.4em;right:-1em;border:solid 1px;padding:1.1em 1.2em 0.9em 1.2em;border-radius:2em">';
        szHtml += '<b><a href="javascript:ixmaps.legend.removeExternalLegend(\'' + "" + '\')" style="text-decoration:none">X</a></b></div>';
        $("#map-legend").html(szHtml);
         $("#map-legend").show();
   ...
   ixmaps.legend.removeExternalLegend = function (szUrl) {
    ...
    ixmaps.htmlgui_onDrawTheme = function (szId) {
        ...
        if (ixmaps.legend.url && ( ixmaps.legend.url.match(/html/) || ixmaps.legend.url.match(/..\/..\//)) ) {
