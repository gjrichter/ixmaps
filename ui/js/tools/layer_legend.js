...
(function () {
		...
		__makeLegendType = function(layer,name,type){
			...
			if ( layer.categoryA && (layer.szType == type) ){
				...
				szLegend += sub?"<div class='list-group' style='margin-top:0.5em;margin-bottom:2.5em;'>":"";
				...
				switch( layer.szType ){
					case "point":
						for ( c in layer.categoryA ){  
							...
							szLegend += '<input type="checkbox" class="check sub_check" '+szChecked+' style="margin:0.4em 0em 0 0.2em;float:right" onchange="javascript:ixmaps.__switchLayer($(this),\''+name+((c&&(layer.categoryA[c].legendname))?('::'+c):'')+'\');">&nbsp;';
					...
					case "line":
						for ( c in layer.categoryA ){
							...
							szLegend += "<span style='vertical-align:1.1em;font-size:0.2em;margin-left:0.3em;background:"+layer.categoryA[c].fill+"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>&nbsp;&nbsp;"+szCatogoryName+"</div>";
