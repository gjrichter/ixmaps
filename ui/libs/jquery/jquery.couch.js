...
(function($) {
  ...
  $.extend($.couch, {
    ...
    config: function(options, section, option, value) {
      ...
      if (value === null) {
        ...
        req.contentType = "application/jsonp";
    ...
    login: function(options) {
      options = options || {};
      $.ajax({
        type: "POST", url: this.urlPrefix + "/_session", dataType: "jsonp",
    ...
    logout: function(options) {
      options = options || {};
      $.ajax({
        type: "DELETE", url: this.urlPrefix + "/_session", dataType: "jsonp",
    ...
    db: function(name, db_opts) {
      ...
      return {
        ...
        create: function(options) {
          ...
          ajax({
              type: "PUT", url: this.uri, contentType: "application/jsonp",
              data: "", processData: false
            },
            options,
        ...
        saveDoc: function(doc, options) {
          ...
          $.ajax({
            ...
            dataType: "jsonp", data: toJSON(doc),
        ...
        bulkSave: function(docs, options) {
          ...
          ajax({
              ...
              contentType: "application/jsonp", data: toJSON(docs)
            },
            options,
        ...
        query: function(mapFun, reduceFun, language, options) {
          ...
          ajax({
              ...
              contentType: "application/jsonp", data: toJSON(body)
            },
            options,
  ...
  var httpData = $.httpData || function( xhr, type, s ) { // lifted from jq1.4.4
    ...
    if ( typeof data === "string" ) {
      if ( type === "jsonp" || !type && ct.indexOf("jsonp") >= 0 ) {
        data = $.parseJSON( data );
  ...
  function ajax(obj, options, errorMessage, ajaxOptions) {
    ...
    $.ajax($.extend($.extend({
      type: "GET", dataType: "jsonp", cache : !$.browser.msie,
      beforeSend: function(xhr){
