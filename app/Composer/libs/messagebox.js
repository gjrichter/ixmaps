...
function getMessageContent(messagType, header, content) {
    ...
    if (messagType == MESSAGE_TYPE.Confirmation) {
        ...
        + '<a id="MsgOkButton" href="#" data-role="button"><span class="messagebox_button" style="color:red">ok</span></a>'
        + ''
        + ''
        + '<a id="CancelButton" href="#" data-role="button"><span class="messagebox_button">cancel</span></a>'
        + '</div>';
    }else
