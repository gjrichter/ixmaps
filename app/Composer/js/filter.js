...
(function () {
    ...
    __setFacetFilter = function (szFilter) {
        ...
        __dataFacetsSetFilter(null, szFilter);
         return;
    ...
    __HighlightFacetItems = function (szField, szValue) {
        console.log("__HighlightFacetItems");
        var objTheme = ixmaps.getThemeObj();
    ...
    ixmaps.data.showFacets = function (szFilter, szDiv, facetsA) {
        ...
        var szHtml = "";
        szHtml += "<div id='list-facets-"+ixmaps.data.facetsDataName+"' class='list-group' style='width:100%;margin-bottom:5em;'>";
        ...
        **/
        for (var i = 0; i < facetsA.length; i++) {
            ...
            var bgColor = fActiveFacet ? "#884444" : "#F0F0F0";
            var color   = fActiveFacet ? "white" : "black";
            ...
            szHtml += "<div style='font-family:arial;font-size:1em;text-align:left;padding:0.5em 0.5em 0.5em 0.5em;margin:1em 0.4em 0.4em 0;background:" + bgColor + ";color" + color + ";border-radius:5px;font-weight:bold'>";
            szHtml += facetsA[i].id;
            ...
            szHtml += fActiveFacet ? "<span style='float:right;margin-right:0em;padding-top:0em;'>X</span>" : "";
            szHtml += "</div>";
            ...
            if (facetsA[i].values) {
                ...
                for (var ii = 0; ii < facetsA[i].values.length; ii++) {
                    ...
                    if (facetsA[i].values[ii].length && (facetsA[i].values[ii] != " ")) {
                        ...
                        var bgColor = "";
                        var szCount = ixmaps.formatValue(nCount, 0, "BLANK");
                        ...
                        **/
                        ...
                        szHtml += '<button type="button" class="btn btn-block btn-primary " style="width:100%;border:none;border-bottom:solid #dddddd 0.1px;border-radius:0;padding:0em 0.5em"><span style="margin-left:-0.5em;float:left;white-space:normal;text-align:left;margin-top:0.2em">' + szText + '</span><span class="badge badge-primary badge-pill pull-right" style="top:0.1em;right:-0.25em;float:right;text-align:right;font-size:18px" onmouseover=\'' + szHighlight + '\' onmouseout=\'' + szClearHighlight + '\'>' + szCount + '</span></button>';
     ...
     ixmaps.data.initSliders = function (sliderA) {
       ...
       sliderA.forEach(function (x) {
            ...
            var mySlider = $("#" + x.id).slider({
                ...
                __setRangeFilter(x.field, $(this).val(), $(this).attr("data-slider-min"), $(this).attr("data-slider-max"));
            }).on("slide", function () {
    ...
    ixmaps.data.makeFacets = function (szFilter, szDiv, dataObj) {
