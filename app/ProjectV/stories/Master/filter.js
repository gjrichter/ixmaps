					...
					for (var ii = 0; ii <facetsA[i].values.length; ii++) {
						...
						if (facetsA[i].values[ii] != " ") {
                            ...
                            if ( !isNaN(nWidth) && (nWidth<100) && (facetsA[i].uniqueValues > 2) ) {
                                szHtml += '<div style="position:relative;top:0.25em;left:0.1em;background:rgba(128,128,128,1);line-height:0.4em;width:'+nWidth+'%;border-radius:0 0.5em 0.5em 0">&nbsp;</div>';                               
                                }
