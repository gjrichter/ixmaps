...
(function () {
    ...
    ixmaps.legend.makeColorLegendHTMLCompact = function (szId, szLegendId) {
        ...
        szHtml += "<td colspan='" + (span) + "' >" + ixmaps.__formatValue(themeObj.nMin, nDecimals, "SPACE") + szUnit + "</td>";
        szHtml += "<td colspan='" + (nColors - span) + "' align='right'>" + ixmaps.__formatValue(themeObj.nMax, nDecimals, "SPACE") + ((szUnit.length <= 3) ? szUnit : "") + "</td>";
        szHtml += "</tr>";
